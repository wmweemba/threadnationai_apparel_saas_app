...
export function ConsentGate({ open, onAccept }: ConsentGateProps) {
  ...
  return (
    <Dialog open={open}>
      <DialogContent
        className="bg-surface-card border-[rgba(255,255,255,0.08)] max-w-lg"
        onInteractOutside={(e) => e.preventDefault()}
      >
        <DialogHeader>
          <div className="flex items-center gap-3 mb-2">
            <span className="text-kente-gold text-2xl font-syne font-extrabold">✦</span>
            <DialogTitle className="font-syne font-extrabold text-xl text-text-primary">
              ThreadNation AI
            </DialogTitle>
          </div>
        ...
        <div className="space-y-4 py-2">
          ...
          <ul className="space-y-3 text-sm text-warm-dim">
            <li className="flex gap-3">
              <span className="text-kente-gold mt-0.5 flex-shrink-0">✦</span>
              <span>
        ...
        <div className="pt-2">
          ...
          <p className="text-center text-xs text-warm-dim mt-3">
